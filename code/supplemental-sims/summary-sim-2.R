# summary-sim-2.R: this script summarizes the second supplemental simulation study from
...
# Load results ------------------------------------------------------------
load("results/supplemental-sims/sim-2-results.rda")
...
# This is part of Supp Info S4 Table 3 
plot.psi.abs.bias.2 %>%
...
# This is part of Supp Info S4 Table 4
plot.w.coverage.2 %>%
  arrange(p.svc, J, n.time) %>%
  print(n = nrow(.))
...
# Create Supp Info S4 Figure 2
ggarrange(psi.bias.plot, psi.ci.width.plot, cor.w.plot, nrow = 3, common.legend = TRUE,
          legend = 'bottom')
ggsave(file = 'figures/Supp-Info-S4-Figure-2.png', units = 'in', device = 'png', 
