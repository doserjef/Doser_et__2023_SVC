# summary-sim-5.R: this script summarizes results from the fifth simulation study
#                  (described in Appendix S2) that shows how estimates from SVC 
...
# Load results ------------------------------------------------------------
load("results/sim-5-results.rda")
# Number of sites
