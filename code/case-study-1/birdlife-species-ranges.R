...
#                            forest bird species in the case study. Note the 
#                            script will not run using the available data on 
#                            GitHub as the BirdLife ranges are proprietary and 
#                            must be obtained via a data sharing agreement.
...
load("data/case-study-1/bird-life-data.rda")
...
# Quick check to make sure it all works properly.
...
save(percent.area, within.sf.list, outside.sf.list, 
     range.ind, file = "data/case-study-1/bird-life-processed.rda")
