# summary-sim-3.R: this script summarizes the third supplemental simulation study from
...
# Load results ------------------------------------------------------------
load("results/supplemental-sims/sim-3-results.rda")
...
# This is part of Supp Info S4 Table 5
plot.w.abs.bias.2 %>%
  arrange(J, n.time) %>%
  print(n = nrow(.))
...
cor.w.plot
ggsave(file = 'figures/Supp-Info-S4-Figure-3.png', units = 'in', device = 'png', 
