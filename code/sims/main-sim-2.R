# main-sim-2-occ.R: code to perform the second simulation study to assess how 
#                   sample size influences the bias and precision of 
#                   estimates from SVC models. In other words, this simulation 
#                   study provides information on the sample size and data 
#                   requirements for reliable estimation of models with SVCs. 
...
save(psi.mean.samples, psi.low.samples, psi.high.samples, 
     ...
     psi.true, w.true, scenario.vals, file = 'results/sim-2-results.rda')
